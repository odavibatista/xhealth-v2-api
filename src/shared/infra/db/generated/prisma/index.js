...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\PICHAU\\OneDrive\\Documentos\\Davi\\Projetos Pessoais\\Angular\\XHealth V2\\xhealth-v2-api\\src\\shared\\infra\\db\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\PICHAU\\OneDrive\\Documentos\\Davi\\Projetos Pessoais\\Angular\\XHealth V2\\xhealth-v2-api\\src\\shared\\infra\\db\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../../../../.env",
  ...
  "inlineSchemaHash": "08082bf7738a92102c683416e0b29f9ff039a8eb98edf023a3ef6b0b358b766a",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/shared/infra/db/generated/prisma",
    "shared/infra/db/generated/prisma",
  ]
...
path.join(process.cwd(), "src/shared/infra/db/generated/prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/shared/infra/db/generated/prisma/schema.prisma")
