...
export const gymSeeder = async () => {
    ...
    const gym1 = {
        name: encrypterProvider.encrypt({ content: 'XHealth São Paulo - Jabaquara' }),
        address_id: gym1Address.id_address,
        phone_number: encrypterProvider.encrypt({ content: '11959872118' }),
        imageUrl: encrypterProvider.encrypt({ content: 'https://i.imgur.com/EN6njoM.jpeg' }),
    }

    const gym2 = {
        name: encrypterProvider.encrypt({ content: 'XHealth São Paulo - Vergueiro' }),
    ...
    const gym3 = {
        name: encrypterProvider.encrypt({ content: 'XHealth São Paulo - Paulista' }),
