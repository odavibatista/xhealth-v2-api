...
export const trainerSeeder = async () => {
    ...
    const trainer1 = {
        ...
        instagramUrl: encrypterProvider.encrypt({ content: 'https://instagram.com' }),
        ...
        imageUrl: encrypterProvider.encrypt({ content: 'https://i.imgur.com/8RodANa.jpeg' }),
    }
    ...
    const trainer2 = {
        ...
        twitterUrl: encrypterProvider.encrypt({ content: 'https://twitter.com' }),
        youtubeUrl: encrypterProvider.encrypt({ content: 'https://youtube.com' }),
        imageUrl: encrypterProvider.encrypt({ content: 'https://i.imgur.com/fwT2RWC.jpeg' }),
    }
    ...
    const trainer3 = {
        ...
        twitterUrl: encrypterProvider.encrypt({ content: 'https://twitter.com' }),
        youtubeUrl: encrypterProvider.encrypt({ content: 'https://youtube.com' }),
        imageUrl: encrypterProvider.encrypt({ content: 'https://i.imgur.com/pKbq9IH.jpeg' }),
    }
    ...
    const trainer4 = {
        ...
        twitterUrl: encrypterProvider.encrypt({ content: 'https://twitter.com' }),
        youtubeUrl: encrypterProvider.encrypt({ content: 'https://youtube.com' }),
        imageUrl: encrypterProvider.encrypt({ content: 'https://i.imgur.com/yF6nGKP.jpeg' }),
    }
