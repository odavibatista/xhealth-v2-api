  ...
  let usecase: AdminLoginUsecase;
    ...
    let jwtProvider: JWTProvider;
      ...
      beforeEach(async () => {
        ...
        mockRepository = new AdministratorRepository(encrypterProvider, hashProvider);
      ...
      it('should throw InvalidCredentialsException if admin not found', async () => {
        ...
        await expect(usecase.execute(data)).rejects.toThrow(InvalidCredentialsException);
      });
      ...
      it('should throw InvalidCredentialsException if the e-mail is valid, but the password is invalid', async () => {
        ...
        jest.spyOn(mockRepository, 'findByEmail').mockResolvedValueOnce(mockAdmin as any);
