...
describe('Create Gym Usecase Test Suites', () => {
  ...
  it('should not create a gym if the UF does not exist', async () => {
    const data = {
      name: 'Gym Test',
      address: {
        cep: '12345678',
  ...
  it('should not create a gym if the phone number is already in use by another gym', async () => {
    const data = {
      name: 'Gym Test',
      address: {
        cep: '12345678',
  ...
  it('should not create a gym if the phone number is already in use by a user', async () => {
    const data = {
      name: 'Gym Test',
      address: {
        cep: '12345678',
